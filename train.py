...
def main():
    ...
    # The dataset TXT file contains all image paths and ground truth paths
    ...
    # cp is the temp directory that contains the checkpoint file
...
def train(model, criterion, optimizer, epoch, coco):
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        batch_size=args.batch_size)
    # Transform the model.eval() to model.train()
    model.train()
    end = time.time()
